...
foreach ($resource in $resources) {
    ...
    [void]$builder.AppendLine()
    [void]$builder.AppendLine("## A3S package")
    [void]$builder.AppendLine()
    [void]$builder.AppendLine("- **Catalog package:** ``@a3s-science/$resourceId``")
    [void]$builder.AppendLine("- **Install:** ``a3s install use/a3s/$resourceId``")
    [void]$builder.AppendLine("- **Upgrade:** ``a3s upgrade use/a3s/$resourceId``")
    [void]$builder.AppendLine("- **Uninstall:** ``a3s uninstall use/a3s/$resourceId``")
    [void]$builder.AppendLine()
    [void]$builder.AppendLine("This registry package installs the software knowledge card and this independent modernization blueprint. It does not contain, redistribute, or claim to install the original vendor binary.")
    [void]$builder.AppendLine()
